...
export FABRIC_CA_HOME=$CONFIG_TX_PATH/crypto-config/peerOrganizations/org2.example.com/ca
...
export FABRIC_CA_SERVER_TLS_CERTFILE=$FABRIC_CA_HOME/ca.org2.example.com-cert.pem
